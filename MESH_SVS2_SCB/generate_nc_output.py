...
parser = ArgumentParser(description = """
                                            Script to convert txt file from MESH-SVS into netcdf file
                                            """)

parser.add_argument('-site', help="SnowMIP2 site: Alp, Brm, Frs, Hit, Hyy, Ctb", dest='site')
...
dir_exp= '/home/nil005/store6/Driving_Data/Snow_Crested_Butte/MuSA/DATA/RESULTS'

# Go to exp directory
os.chdir(dir_exp)

# Get list of files containing SVS outputs
list_fic = glob.glob(args.version+'*.csv')
...
var_cum=['RSNOW_AC','LESCAF','RSNOWV_AC']
...
netcdf_file_out = 'out_'+args.version+'.nc'
